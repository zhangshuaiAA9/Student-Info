...
public partial class Teachercode_InputScore : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (myds.Tables["course"].Rows.Count > 0)
            {
                ...
                Response.Write("<script>alert('没有安排任何上课课程!')</script>");
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        //保存成绩
        savedata();
        Response.Write("<script>alert('输入的成绩已保存!')</script>");
    }
